...
next:
  ...
  link: '/operative-v2/01-get-started'
lastUpdated: false
---
...
**Welcome, Operative.**  
Your advanced mission—should you choose to accept it—is to master the art of building **enterprise-grade multi-agent systems** using the new **Microsoft Copilot Studio** experience.
...
| `09` | 🧠 [Generating an Interview Prep Document](./09-document-generation/index.md) | Generate a Word document natively with an agent skill |
