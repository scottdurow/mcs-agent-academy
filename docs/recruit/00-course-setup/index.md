...
A new SharePoint site needs to be created  which will be used in [Lesson 06 - Create a custom agent using the conversational creation experience with Copilot and grounding it with your data](../06-create-agent-from-conversation/index.md#62-add-an-internal-knowledge-source-using-a-sharepoint-site).
