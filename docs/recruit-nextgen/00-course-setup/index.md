...
A new SharePoint site is required for completing `Mission 04 - Build a custom engine agent`. In this step, you'll also create a new list in that site to store available devices.
