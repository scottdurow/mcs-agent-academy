...
# 🚨 Mission 06: Add a Tool {#mission-06-add-a-tool}
...
## 🧪 Lab 06 - Add the SharePoint Get items tool {#lab-06-add-the-sharepoint-get-items-tool}
...
⏭️ [Move to **Automate with Workflows**](../07-automate-with-workflows/index.md)
...
<analytics-tag section="recruit-nextgen" mission="06-add-tools" />
